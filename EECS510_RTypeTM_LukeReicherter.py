...
class RTypeTM:
    ...
    def step(self):
        ...
        if key not in self.transitions:
            # No transition defined: halting condition
            return False
    ...
    def run(self, max_steps=100000):
        ...
        for i in range(len(self.tape)):
            if self.tape[i] == '_' or self.tape[i] == '#':
                self.tape[i] == ''
        return ''.join(self.tape)

    def print_tape(self):
        """Print tape with head position marked."""
...
def main():
    tape = list("00000000001000100000100000000001#A:00111110B:00010101C:11111111D:00000100E:00100000#")
